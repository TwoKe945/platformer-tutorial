...
public class EnemyManager {
    ...
    private void drawCrabbies(Graphics g,  int xLvlOffset) {
        for (Crabby c : crabbies) {
            if (c.isActive()) {
                g.drawImage(crabbyArr[c.getState()][c.getAniIndex()],(int) c.getHitBox().x - CRABBY_DRAW_OFFSET_X - xLvlOffset + c.flipX(),(int) c.getHitBox().y - CRABBY_DRAW_OFFSET_Y,CRABBY_WIDTH * c.flipW(),CRABBY_HEIGHT, null);
